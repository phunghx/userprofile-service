...
import datainsider.user_profile.controller.http.filter.common.{CORSFilter, CaseClassExceptionMapping, CommonExceptionMapping, JsonParseExceptionMapping}
import datainsider.user_profile.controller.http.filter.user.AuthUserParser
import datainsider.user_profile.controller.http.{AuthController, PingController, UserController}
import datainsider.user_profile.controller.thrift.UserProfileController
import datainsider.user_profile.module.{UserProfileModule, UserProfileModuleTestImpl}
